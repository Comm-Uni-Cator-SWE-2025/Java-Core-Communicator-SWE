...
public class SanityTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        dynamo.addUser(new ClientNode("10.128.6.193", 1212), new ClientNode("10.128.5.145", 1212));
        ...
        dynamo.sendData("Hello, world!".getBytes(), new ClientNode[] { new ClientNode("10.128.5.145", 1212) }, 1, 0);
